...
try {
    ...
    seed_exec($conn, 'INSERT IGNORE INTO officialaccessroleprofiletbl (role_access_profile_id, department_key, position_key, department_label, position_label, area_assignee_access, area_coverage_access, permissions_initialized) VALUES (990001, \'demo_department\', \'demo_position\', \'Demo Department\', \'Demo Position\', \'Area01\', \'Area01\', 1)');
    seed_exec($conn, 'INSERT IGNORE INTO officialaccessrolepermissiontbl (role_permission_id, department_key, position_key, department_label, position_label, permission_key, is_allowed, granted_by_user_id) VALUES (990001, \'demo_department\', \'demo_position\', \'Demo Department\', \'Demo Position\', \'dashboard.view\', 1, ?)', [$superAdmin]);
