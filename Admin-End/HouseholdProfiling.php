        ...
        <div class="bg-white p-4 rounded-4 shadow-sm border household-shell">
	            ...
	            <div class="admin-list-toolbar mb-3 pt-2 flex-wrap">
	                ...
	                <div class="admin-list-actions">
	                    ...
	                    <button class="btn btn-outline-secondary btn-icon admin-columns" type="button" data-bs-toggle="modal" data-bs-target="#modalTableColumns" id="btnHouseholdColumns" title="Columns" aria-label="Columns">
	                      <i class="fa-solid fa-sliders"></i>
	                      <span class="visually-hidden">Columns</span>
	                    </button>
	                    <button class="btn btn-outline-secondary btn-icon admin-refresh" type="button" id="btnHouseholdRefresh" title="Refresh table" aria-label="Refresh table">
...
<script>
  window.ADMIN_TABLE_COLUMNS_CONFIG = {
    tableSelector: "#table-householdProfiling",
    modalId: "modalTableColumns",
    listId: "tableColumnsList",
    resetBtnId: "btnTableColumnsReset",
    storageKey: "admin_cols_household_profiling_v1"
  };
</script>
