...
$isBlotterMainNavActive = $sbMainNavActiveWithoutSubtab($isBlotterActive, [
  $sbCan('blotter_log_new_incident') && $current === 'BlotterForm.php',
...
$isComplaintMainNavActive = $sbMainNavActiveWithoutSubtab($isComplaintActive, [
  $sbCan('complaint_log_new_incident') && $current === 'ComplaintForm.php',
...
$sbModuleAttentionCounts = [
  ...
  'resident_profiling' => ($sbCan('resident_masterlist') ? $sbCount('resident_tracker') : 0)
  ...
  'finance_transactions' => ($sbCan('finance_payment_tracker') ? $sbCount('finance_payment_tracker') : 0)
...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-white shadow-sm"
  ...
  <div class="sidebar-body d-flex flex-column flex-grow-1">
    <ul class="list-unstyled ps-0 flex-grow-1 mb-0">
      ...
      <?php if ($sbCan('blotter_log_new_incident') || $sbCan('blotter_tracker')): ?>
                ...
                <?php if ($sbCan('blotter_log_new_incident')): ?>
                  <li>
                    <a href="<?= htmlspecialchars(appUrl('Admin-End/Blotter/BlotterForm.php')) ?>"
                      class="link-dark rounded sidebar-subnav-link <?= $current == 'BlotterForm.php' ? 'active' : '' ?>">
                      <span class="sidebar-subnav-text">Log New Incident</span>
                    </a>
                  </li>
                <?php endif; ?>
      ...
      <?php if ($sbCan('complaint_log_new_incident') || $sbCan('complaint_tracker')): ?>
                ...
                <?php if ($sbCan('complaint_log_new_incident')): ?>
                  <li>
                    <a href="<?= htmlspecialchars(appUrl('Admin-End/Complaints/ComplaintForm.php')) ?>"
                      class="link-dark rounded sidebar-subnav-link <?= $current == 'ComplaintForm.php' ? 'active' : '' ?>">
                      <span class="sidebar-subnav-text">Log New Complaint</span>
                    </a>
                  </li>
                <?php endif; ?>
...
<script src="<?= htmlspecialchars(appUrl('/JS-Script-Files/Admin-End/adminTableActions.js?v=20260825-action-dropdown-readable'), ENT_QUOTES, 'UTF-8') ?>"></script>