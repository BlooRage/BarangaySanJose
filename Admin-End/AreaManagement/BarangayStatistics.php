...
<div class="d-flex flex-column flex-md-row" style="min-height: 100vh;">
  ...
  <main class="flex-grow-1 p-3 p-md-4 p-xl-5 bg-light" id="main-display">
    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
      <div>
        <h1 class="mb-2" style="font-family: 'Charis SIL Bold'; color: #DE710C; ">Barangay Statistics</h1>
        <p class="mb-0 text-muted">Barangay-wide analytics moved out of the dashboard into a dedicated statistics view.</p>
      </div>
      <a href="<?= htmlspecialchars(appUrl('Admin-End/AreaManagement/AreaStatistics.php?tab=summary')) ?>" class="btn btn-outline-primary">
        Open Area Statistics
      </a>
    </div>
    <hr><br>
    ...
    <section class="analytics-section">
      <div class="analytics-header d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-2 mb-3">
        <div>
          <h2 class="analytics-title mb-1">Resident and Case Analytics</h2>
