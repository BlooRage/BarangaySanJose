...
<head>
  ...
  <link rel="stylesheet" href="../CSS-Styles/Admin-End-CSS/AdminDashboardStyle.css?v=20260811-1">
</head>
...
<div class="d-flex flex-column flex-md-row" style="min-height: 100vh;">
  ...
  <?php
    ...
    $addModuleCard($sbCan('officials_management') || $sbCan('personnel_invite'), 'personnel-management', 'Personnel Management', appUrl($sbCan('officials_management') ? 'Admin-End/PersonnelTracker.php' : 'Admin-End/OfficialInvites.php'), 'fa-user-tie', 'Open the personnel tracker, invites, and access control workspace.', 0);
