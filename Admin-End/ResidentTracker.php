        ...
        <div id="div-tableContainer" class="bg-white p-4 rounded-4 shadow-sm border resident-masterlist-shell">
            ...
            <div class="resident-table-footer mt-3 d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <nav aria-label="Resident pagination">
                    <ul class="pagination pagination-sm mb-0" id="residentPagination"></ul>
                </nav>
            </div>
        ...
        <div class="modal-content border-0 rounded-2 p-4">
            ...
            <div class="modal-body">
                ...
                <div id="div-infoGroup" class="div-infoContainer tracker-profile-view">
                    ...
                    <div class="p-3 rounded-3 mb-3 border-0 bg-white tracker-form-section" id="view-contact-wrapper">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <p id="txt-modalContactNumber" class="fw-bold mb-0"></p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-muted small mb-0">Email Address:</p>
                                <p id="txt-modalEmailAddress" class="fw-bold mb-0"></p>
                            </div>
                        </div>
                    </div>
      ...
      <div class="modal-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-3">
            ...
            <input type="date" id="edit-birthdate" name="dateOfBirth" class="form-control" min="1916-01-01" max="<?= date('Y-m-d') ?>" data-date-modal-style="calendar" required>
          </div>
          <div class="col-md-3">
