...
$configuredPurposeOptions = dms_document_purpose_options($conn, 'firsttimejobseeker');
...
<body>
    ...
    <div class="d-flex min-vh-100">
        ...
        <main id="div-mainDisplay" class="flex-grow-1 px-4 pb-4 pt-0 px-md-5 pb-md-5 pt-md-0">
                    ...
                    <div class="position-relative d-flex align-items-center justify-content-center mb-2 pt-4">
                        ...
                        <h1 class="form-title m-0">First Time Job Seeker</h1>
                    </div>
                    <p class="form-subtitle">All fields marked with <span class="required-asterisk">*</span> are required</p>

                    <form class="page-form" method="POST" action="<?= htmlspecialchars($baseUrl) ?>/PhpFiles/Resident-End/documentRequestWorkflow.php">
    ...
    <script src="<?= htmlspecialchars($baseUrl) ?>/JS-Script-Files/Resident-End/Certificates/firstTimeJobSeekerFormScript.js"></script>
</body>
