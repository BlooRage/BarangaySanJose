...
<head>
    <meta charset="UTF-8">
    <title>Application for Barangay Clearance for Commercial Permit - Barangay San Jose</title>
...
<div class="d-flex min-vh-100">
    ...
    <main id="div-mainDisplay" class="flex-grow-1 px-4 pb-4 pt-0 px-md-5 pb-md-5 pt-md-0 bg-light">
        <div class="main-head application-card orange-card application-card--muted py-3 my-5 rounded">
            ...
            <h1 class="form-title">Application for Barangay Clearance for Commercial Permit</h1>
