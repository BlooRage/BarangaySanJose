...
// Canonical endpoint lives under PhpFiles/Login/changePassword.php.
require_once __DIR__ . '/../Login/changePassword.php';
exit;
...
// Same policy as registration JS/PHP.
...
try {
    ...
    // History policy: reject if used in last 3 passwords, or within last 6 months.
    // If the history table doesn't exist, skip these checks.
    $historyOk = true;
    ...
    // Trim history table (best-effort).
    $trim = $conn->prepare("
