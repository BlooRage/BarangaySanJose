...
amp_require_json_module_permission($conn, 'resident_sector_membership_verification', [
    'success' => false,
    'message' => 'You do not have permission to review sector membership requests.',
]);
